# Generated by Django 5.1.3 on 2025-03-20 10:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quelle_typ', models.CharField(choices=[('Fachschaft', 'Fachschaft'), ('Externe Website', 'Externe Website'), ('Sammel-Rundmail', 'Sammel-Rundmail'), ('Rundmail', 'Rundmail'), ('Interne Website', 'Interne Website')], max_length=20)),
                ('kategorien', models.ManyToManyField(blank=True, to='news.kategorie')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rolle', models.CharField(choices=[('Student', 'Student'), ('Angestellter', 'Angestellter')], max_length=20)),
                ...
                ('standorte', models.ManyToManyField(blank=True, to='news.standort')),
                ('fachschaften', models.ManyToManyField(blank=True, to='news.fachschaft')),
            ],
            options={
                'verbose_name': 'user',
